...
func (s *TransformerSuite) TestTransform() {
	...
	s.Equal("github.com/electrious-go/proteus/fixtures", pkg.Path)
	...
	s.Equal([]string{
		...
		"google/protobuf/timestamp.proto",
		"github.com/electrious-go/proteus/fixtures/subpkg/generated.proto",
	}, pkg.Imports)
	...
	s.Equal("github.com/electrious-go/proteus/fixtures/subpkg", pkg.Path)
...
const project = "github.com/electrious-go/proteus"
